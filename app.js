...
47:02 - метод toString() преобразовывает переменную в строку.
1:00:38 - typeof - проверка типа данных.
1:17:49 - ready ? console.log('Готово!') : console.log('Не готово') - тернарное выражение (короткая запись проверки boolean переменной).
